...
var countDownDate = new Date("Oct 16, 2020 15:52:00").getTime();
...
3. Ihr nehmt am Wettbewerb teil indem ihr eure beste Graphik im `.png` Format und das zugehörige R Script einreicht.

4. Vor dem Einreichen, speichert eure Graphik mittels `ggsave()` (siehe code) und benennt die Datei mit eurem *Gruppennamen*. Benutzt euren *Gruppennamen* ebenfalls im Namen der `.R` Skriptdatei (siehe oben). 
...
5. Reicht euren Beitrag über diesen Link ein: 

- [**Graphik + Skript einreichen**](https://www.dropbox.com/request/G8GcXUsYXDdvNq2QlRf5)

6. Jeder Beitrag wird beurteilt duch eine Jury bestehend aus den KursteilnehmerInnen. Der Beitrag mit den im dem höchten Punktemittel gewinnt.   

7. Bitte euren eigenen Beitrag nicht bewerten!
