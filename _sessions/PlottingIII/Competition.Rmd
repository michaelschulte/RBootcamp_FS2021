...
4. Vor dem Einreichen, speichere deine Graphik mittels `ggsave()` (siehe code) und benennt die Datei mit eurem *Gruppennamen*. Benutzt euren *Gruppennamen* ebenfalls im Namen der `.R` Skriptdatei (siehe oben). 
...
5. Reiche deinen Beitrag über diesen Link ein: 

- [**Graphik + Skript einreichen**](https://www.dropbox.com/request/yKJIygRY1BZkpOj3ljMb)

6. Jeder Beitrag wird duch eine Jury beurteilt, diese besteht aus den KursteilnehmerInnen. Der Beitrag mit dem höchsten Punktemittel gewinnt.   

7. Bitte deinen eigenen Beitrag nicht bewerten!
