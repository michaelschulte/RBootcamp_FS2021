...
|:----|:-----|:------|:------|
|[prices.csv](https://github.com/michaelschulte/RBootcamp_FS2021/blob/master/1_Data/prices.csv?raw=true)| `r nrow(prices)` | `r ncol(prices)`| Datensatz zu den Avocado der Firma Hass Preisen in verschiedenen amerikanischen Staaten|
