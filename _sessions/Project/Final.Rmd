...
- Fragestellung abgeben (Frage + grobe Skizze wie du Frage beantworten willst, via email an: <a href="mailto:michael.schulte@unibe.ch">michael.schulte@unibe.ch</a> abgene (27.05.21, 12.00 Uhr (high noon))
...
1. Beantworte deine Fragestellung mit all den verschiedenen Ansätzen, die wir im Kurs durchgemacht haben - Tabelle, Grafiken, Statistik (deskriptiv und inferenz (Bonus)).
...
5. Erstelle Slides für die Beantwortung der Fragestellung (Tabellen, deskriptive Statistiken, Grafiken)
...
|:----|:-----|:------|:------|
|[prices.csv](https://michaelschulte.github.io/RBootcamp_FS2021/1_Data/prices.csv?raw=true)| `r nrow(prices)` | `r ncol(prices)`| Datensatz zu den Avocado der Firma Hass Preisen in verschiedenen amerikanischen Staaten|
|[sales.csv](https://michaelschulte.github.io/RBootcamp_FS2021/1_Data/sales.csv?raw=true)| `r nrow(sales)` | `r ncol(sales)`| Datensatz zu den Avocado Verkaufszahlen der Firma Hass in verschiedenen amerikanischen Staaten |
